...
$property['apply_btn']		= " <a href=\"[LINK]\" class=\"btn btn-lg btn-board-03\" role=\"button\">지원하기</a> ";
...
$property['NOTICE_ICON'] = "<span class=\"badge badge-dark mr-1 d-lg-none\">NOTICE</span>";
...
{*/
	$property['list_html_row'] = 
					"<tr class=\"[NOTICE_CLS]\">
						...
						<td class=\"d-none d-lg-table-cell\">[TMP_FIELD5] ~ [TMP_FIELD6]</td>
						<td class=\"d-none d-lg-table-cell\">[USER]</td>
						<td class=\"d-none d-lg-table-cell\">[DATE]</td>
						<td class=\"d-none d-lg-table-cell\">[STATE]</td>
					</tr>";
